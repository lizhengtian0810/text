...
import zxing.image.DataCenter;
import zxing.image.DataObservable;

public class Main_QR_Activity extends Activity implements DataObservable{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qr_home);
        ...
        mButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                //观察者事件通知
                DataCenter.notifyData(0x0010, 0, "出货口检测");
//                Intent intent = new Intent();
//                intent.setClass(Main_QR_Activity.this, MipcaActivityCapture.class);
...
//                startActivityForResult(intent, SCANNIN_GREQUEST_CODE);
    ...
    @Override
    public void onDataChange(int action, long params, Object value) {
switch (action){
    case 0x0010:
        Log.d("================",value+"");
        break;
